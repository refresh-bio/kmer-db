...
* `-k <kmer-length>` - length of k-mers (default: 18); ignored when `-from-kmers` or `-from-minhash` switches are specified. 
...
* &#124;*q &cap; s*&#124; - number of k-mers common for samples *q* and *s*.
